'use strict';
/* build-hook-start *//*00001*/try { require('/Users/mailbitsales/.vscode/extensions/wallabyjs.console-ninja-1.0.432/out/buildHook/index.js').default({tool: 'jest', checkSum: '20427cd6fd9ebf397ed6f1BgsZVEoGXAdYVwdeBAoDXQAFUVIE', mode: 'build'}); } catch(cjsError) { try { import('file:///Users/mailbitsales/.vscode/extensions/wallabyjs.console-ninja-1.0.432/out/buildHook/index.js').then(m => m.default.default({tool: 'jest', checkSum: '20427cd6fd9ebf397ed6f1BgsZVEoGXAdYVwdeBAoDXQAFUVIE', mode: 'build'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
