...
class Clock extends Time {
    ...
    start() {
        if (this.intervalId === null) {
            this.intervalId = setInterval(() => this.addSeconds(1), 1000);
        }
    }
...
try {
    ...
    const clock = new Clock({ hours: 10, minutes: 30, seconds: 0, autoStart: true });

    console.log('Initial Time:', clock.toString());
